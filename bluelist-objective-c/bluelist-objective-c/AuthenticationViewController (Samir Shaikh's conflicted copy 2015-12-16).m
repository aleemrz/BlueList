...
//                            self.progressLabel.text = [NSString stringWithFormat:@"Sorry, the system is overloaded. Please retry after 5 minutes." ];
                            dispatch_sync(dispatch_get_main_queue(), ^{
                                [self invalidAuthentication:[NSString stringWithFormat:@"Sorry, the system is overloaded. Please retry after 5 minutes id %@.  Error connecting to database: %@", self.userId, error]]; });
                        }else{
